...
VALUES
    ...
    ('Space Farce', 140, 'assets/platzhalter.png', 12, 'Eine Crew voller Idioten versucht, das Universum zu retten.', 'Sci-Fi, Action, Comedy', 'Han Yolo', 'J.J. Abrahaha', 'Deutsch'),
    ...
    ('Droid Hard', 95, 'assets/platzhalter.png', 6, 'Ein kleiner Roboter nimmt es mit der KI-Mafia auf.', 'Sci-Fi, Animation', 'Bleep Bloop', 'Pete Drinker', 'Deutsch'),
    ('Guardians of the Lunacy', 130, 'assets/platzhalter.png', 12, 'Eine chaotische Truppe schuetzt das Universum – irgendwie.', 'Sci-Fi, Comedy', 'Chris Plattfall', 'James Gunner', 'Englisch'),
    ('Back to the Futura', 116, 'assets/platzhalter.png', 12, 'Ein Zeitreisender landet in einer dystopischen Zukunft.', 'Sci-Fi, Adventure', 'Marty McGigawatts', 'Robert Zoomekis', 'Deutsch'),
