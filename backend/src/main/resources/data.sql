...
VALUES
    ...
    ('Guardians of the Lunacy', 130, 'guardians_lunacy.jpg', 12, 'Eine chaotische Truppe schuetzt das Universum – irgendwie.', 'Sci-Fi, Comedy', 'Chris Plattfall', 'James Gunner', 'Englisch'),
    ('Back to the Futura', 116, 'back_futura.jpg', 12, 'Ein Zeitreisender landet in einer dystopischen Zukunft.', 'Sci-Fi, Adventure', 'Marty McGigawatts', 'Robert Zoomekis', 'Deutsch'),
    ('Clown Wars: The Honk Awakens', 105, 'clown_wars.jpg', 12, 'Ein Krieg zwischen ausserirdischen Clowns und der Menschheit.', 'Sci-Fi, Horror, Comedy', 'Penny Wisecrack', 'Tim Burtonisch', 'Englisch');
...
VALUES
    ...
    ('2025-03-22 13:45:00', '2025-03-22 16:45:00', 6, 750, 1),
